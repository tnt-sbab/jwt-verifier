...
func TestToken_VerifyClaims(t *testing.T) {
	token := Token{"", "eyJpc3MiOiJTQkFCIiwiZXhwIjoxNjUwNTU0MDM0LCJqdGkiOiJpdDU5Z0JyUDAwVFZVZzd2WlQtWkJ3IiwiaWF0IjoxNjUwNTI1MjM0LCJuYmYiOjE2NTA1MjUxMTQsInN1YiI6InRlc3QifQ", ""}
	err := token.VerifyClaims(1650525234, "SBAB")
	if err != nil {
		t.Errorf("Claims should be valid [%s]", err.Error())
	}
}
